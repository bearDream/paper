...
public final class HttpConsts {
	...
	enum ContentType{
		 ...
		 * MUL_FORM_TYPE	->			multipart/form-data
		 */
		JSON_TYPE("application/json", Charset.forName("UTF-8")),
		FORM_TYPE("application/x-www-form-urlencoded", Charset.forName("UTF-8")),
		XML_TYPE("application/xml", Charset.forName("UTF-8")),
		JAVA_TYPE("application/x-java-serialized-object", Charset.forName("UTF-8")),
		MUL_FORM_TYPE("multipart/form-data", Charset.forName("UTF-8"));
